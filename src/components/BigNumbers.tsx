        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              {/* Number */}
              <div className="mb-4">
                <span className="text-5xl md:text-6xl font-bold text-white group-hover:text-yellow-300 transition-colors duration-300">
                  {stat.number}
                </span>
                <span className="text-2xl md:text-3xl font-bold text-yellow-300 ml-1">
                  {stat.unit}
                </span>
              </div>
